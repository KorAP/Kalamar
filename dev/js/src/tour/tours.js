...
define(['lib/intro', 'vc', 'hint', 'menu', 'vc/doc', 'vc/docgroup'],
  ...
  loc.TOUR_searAnnot = loc.TOUR_searAnnot || "<p> For querying annotations you can use the annotation assistant. </p> " +
                                             "<p>  Click at the orange bar " +
                                             "or use the down array key &darr; for display. </p>";
  loc.TOUR_annotAssti =  loc.TOUR_annotAssti || "Annotation Assistant (2)";
  loc.TOUR_annotAss =  loc.TOUR_annotAss || "The assistant lists the annotations of the different layers and helps to formulate queries.";
  ...
  loc.TOUR_vccho4 = loc.TOUR_vccho4 || "Here as an example the request for all documents with the document sigle " + loc.TOUR_DocSigle + ".";
  loc.TOUR_vcStat1ti = loc.TOUR_vcStat1ti || "Corpus Statistic (1)";
  loc.TOUR_vcStat1 = loc.TOUR_vcStat1 || "Click here to display the corpus statistic.";
  loc.TOUR_vcStat2ti = loc.TOUR_vcStat2ti || "Corpus Statistic (2)";
  loc.TOUR_vcStat2 = loc.TOUR_vcStat2 || "Here you can see the corpus statistic.";
  ...
  loc.TOUR_seargo = loc.TOUR_seargo || "Start the search by clicking at the magnifying glass.";

  //localization guided Tour gTshowResults
  loc.TOUR_kwicti = loc.TOUR_kwicti || "Results";
  loc.TOUR_kwic = loc.TOUR_kwic || "The results of the query are displayed as KWIC (keyword in context). On the left you can see the according text sigle.";
  ...
  loc.TOUR_snippetb = loc.TOUR_snippetb || "At the bottom of the snippet there is a button group with further views of the results.";
