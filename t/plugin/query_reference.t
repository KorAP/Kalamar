...
$t->put_ok('/query2/baum')
  ->status_is(400)
  ->json_like('/errors/0/message', qr!unable!i)
  ;

$t->put_ok('/query2/baum?q=[orth=Baum]')
  ->status_is(201)
  ->content_is('')
  ;

$t->put_ok('/query2/frage?q=[orth=Frage]&desc=Eine Frage-Query&ql=poliqarp')
  ->status_is(201)
  ->content_is('')
  ;

$t->put_ok('/query2/baum?q=[orth=Baum]&desc=Eine Baum-Query')
  ->status_is(400)
  ->json_like('/errors/0/message', qr!unable!i)
  ;
...
$t->delete_ok('/query2/frage')
  ->status_is(200)
  ->content_is('')
  ;

$t->delete_ok('/query2/frage2')
  ->status_is(200)
  ->content_is('')
  ;
